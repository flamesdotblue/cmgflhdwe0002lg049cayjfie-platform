...
export default function HeroLaunchCallout() {
  return (
      ...
      <div className="relative mx-auto max-w-5xl px-6">
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/10 to-white/5">
          ...
          <div className="relative z-10 p-8 md:p-12">
            ...
            <h3 className="mt-2 text-2xl md:text-4xl font-semibold">Publish at light‑speed with built‑in hosting</h3>
            <p className="mt-3 text-white/80 max-w-2xl">
              One click to ship. Custom domains, SSL, and blazing asset delivery—no configuration, no friction.
            </p>
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <a href="#" className="px-5 py-3 rounded-full bg-fuchsia-500 hover:bg-fuchsia-400 text-white font-medium transition inline-flex items-center gap-2">
                <Rocket size={16} />
                Get Started Free
              </a>
